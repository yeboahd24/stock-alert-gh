...
func (s *StockService) getMockStocks() []models.EnhancedStock {
	return []models.EnhancedStock{
		...
		},
		{
			...
			Volume:        45000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 850000000.0; return &v }(),
			Sector:        func() *string { v := "Financial Services"; return &v }(),
			Industry:      func() *string { v := "Banking"; return &v }(),
		},
		{
			...
			Volume:        23000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 1200000000.0; return &v }(),
		...
		},
		{
			...
			Volume:        78000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 980000000.0; return &v }(),
			Sector:        func() *string { v := "Energy"; return &v }(),
			Industry:      func() *string { v := "Oil & Gas"; return &v }(),
		},
		{
			Symbol:        "AYRTN",
			Name:          "Ayrton Drug Manufacturing Company Limited",
			CurrentPrice:  1.25,
			PreviousClose: 1.20,
			Change:        0.05,
			ChangePercent: 4.17,
			Volume:        12000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 450000000.0; return &v }(),
			Sector:        func() *string { v := "Healthcare"; return &v }(),
			Industry:      func() *string { v := "Pharmaceuticals"; return &v }(),
		},
		{
			Symbol:        "CLYD",
			...
			Volume:        89000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 320000000.0; return &v }(),
			Sector:        func() *string { v := "Materials"; return &v }(),
			Industry:      func() *string { v := "Construction Materials"; return &v }(),
		},
		{
			Symbol:        "FML",
			...
			Volume:        34000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 1650000000.0; return &v }(),
			Sector:        func() *string { v := "Consumer Goods"; return &v }(),
			Industry:      func() *string { v := "Food & Beverages"; return &v }(),
		},
		{
			Symbol:        "UNIL",
			...
			Volume:        56000,
			LastUpdated:   time.Now(),
			MarketCap:     func() *float64 { v := 2800000000.0; return &v }(),
			Sector:        func() *string { v := "Consumer Goods"; return &v }(),
			Industry:      func() *string { v := "Personal Care"; return &v }(),
		},
	}
}
